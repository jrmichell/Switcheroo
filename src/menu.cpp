    ...
    do {
        ...
        switch (option) {
            ...
            case 3:
                ...
                break;
            case 4: break;
            default: std::println("Please enter a valid option.\n");
        }
    } while (option != 4);
}
    ...
    do {
        ...
        switch (option) {
            case 1:
                ...
                switch (file_type) {
                    case FileType::CSV:
                    case FileType::JSON: converter.convert(); break;
                    case FileType::NONE: std::println("Failed to read file extension."); break;
                }
                break;
            case 2:
                file_type = read_input_file_type();
                ...
                break;
            case 3: prompt_data_validation_menu(validator); break;
            case 4: std::println("Goodbye!"); break;
            default: std::println("Please enter a valid option.\n");
        }
    } while (option != 4);
}
